...
| Device Mode | Value Selector | `deviceMode` | AUTO / MANUAL/NIGHT selection |
...
| Charts | Show live and historical lux, voltage, current, and power data |
---
...
│── dashboard.png           # Screenshots and photos
│── solar_tracker_wiring.drawio.png  # Screenshots and photos
|── ina226_power_circuit.drawio.png  # Screenshots and photos
